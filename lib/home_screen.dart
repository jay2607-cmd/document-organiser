...
import 'package:document_organiser/document_picker.dart';
import 'package:document_organiser/pdf_preview.dart';
...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  ...
  DocumentPickerState documentPickerState = DocumentPickerState();
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text("MyDocs"),
          bottom: TabBar(
            tabs: [Tab(text: "Images",),Tab(text: "PDFs",),],
          ),
          actions: [
            IconButton(
                onPressed: () {
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => DocumentPicker()));
                },
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return GestureDetector(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                            height: 250, width: 250, child: Image.file(file)),
                        // Text(file.path),
                  ...
                  return GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => PdfPreview(PdfPath: pdfFiles[index].path,)));
                    },
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      mainAxisAlignment: MainAxisAlignment.center,
